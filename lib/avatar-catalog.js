...
export const AVATAR_SLOTS = [
  'base', 'hair', 'haircolor', 'face', 'beard', 'makeup', 'earrings',
  'outfit', 'hat', 'accessory', 'pet', 'background',
];
...
export const AVATAR_ITEMS = [
  ...
  // --- hair style (four neutral defaults available to everyone, lots to unlock) ---
  { id: 'hair_none',     slot: 'hair', name: 'Bald',        unlock: { level: 1 } },
  { id: 'hair_crop',     slot: 'hair', name: 'Short Crop',  unlock: { level: 1 } },
  { id: 'hair_buzz',     slot: 'hair', name: 'Buzz Cut',    unlock: { level: 1 } },
  { id: 'hair_long',     slot: 'hair', name: 'Long',        unlock: { level: 1 } },
  { id: 'hair_ponytail', slot: 'hair', name: 'Ponytail',    unlock: { level: 1 } },
  { id: 'hair_shortfem', slot: 'hair', name: 'Short Layers',    unlock: { level: 1 } },
  { id: 'hair_medfem',   slot: 'hair', name: 'Shoulder Length', unlock: { level: 1 } },
  { id: 'hair_curly',    slot: 'hair', name: 'Curly',       unlock: { level: 1 } },
  // Long AND curly. The set had Long, Wavy Long and Shoulder Length (all smooth)
  // plus Curly (short), so anyone with long curly hair had to pick which half of
  // themselves to give up. Level 1, like every other everyday style — the unlockable
  // tiers are for novelty looks, not for hair someone actually has.
  { id: 'hair_curlylong', slot: 'hair', name: 'Long Curly', unlock: { level: 1 } },
  { id: 'hair_afro',     slot: 'hair', name: 'Afro',        unlock: { level: 1 } },
  { id: 'hair_bob',      slot: 'hair', name: 'Bob',         unlock: { level: 7 } },
  { id: 'hair_spiky',    slot: 'hair', name: 'Spiky',       unlock: { level: 10 } },
  { id: 'hair_mohawk',   slot: 'hair', name: 'Mohawk',      unlock: { level: 16 } },
  { id: 'hair_bun',      slot: 'hair', name: 'Top Bun',     unlock: { level: 22 } },
  { id: 'hair_pixie',    slot: 'hair', name: 'Pixie',       unlock: { level: 13 } },
  { id: 'hair_pigtails', slot: 'hair', name: 'Pigtails',    unlock: { level: 35 } },
  { id: 'hair_spacebuns', slot: 'hair', name: 'Space Buns', unlock: { level: 40 } },
  { id: 'hair_wavy',     slot: 'hair', name: 'Wavy Long',   unlock: { level: 48 } },
  { id: 'hair_sidebraid', slot: 'hair', name: 'Side Braid', unlock: { level: 58 } },
  { id: 'hair_undercut', slot: 'hair', name: 'Undercut',    unlock: { level: 62 } },
  { id: 'hair_locs',     slot: 'hair', name: 'Locs',        unlock: { level: 78 } },
  { id: 'hair_mullet',   slot: 'hair', name: 'Mullet',      unlock: { level: 95 } },

  // --- hair color (natural from the start, bold colors unlockable) ---
  { id: 'hcolor_brown',   slot: 'haircolor', name: 'Brown',   color: '#6b4423', unlock: { level: 1 } },
  { id: 'hcolor_black',   slot: 'haircolor', name: 'Black',   color: '#1f2937', unlock: { level: 1 } },
  { id: 'hcolor_blonde',  slot: 'haircolor', name: 'Blonde',  color: '#e6b85c', unlock: { level: 1 } },
  { id: 'hcolor_ginger',  slot: 'haircolor', name: 'Red',     color: '#c2552b', unlock: { level: 1 } },
  { id: 'hcolor_gray',    slot: 'haircolor', name: 'Gray',    color: '#9ca3af', unlock: { level: 1 } },
  { id: 'hcolor_blue',    slot: 'haircolor', name: 'Blue',    color: '#3b82f6', unlock: { level: 8 } },
  { id: 'hcolor_pink',    slot: 'haircolor', name: 'Pink',    color: '#ec4899', unlock: { level: 14 } },
  { id: 'hcolor_purple',  slot: 'haircolor', name: 'Purple',  color: '#8b5cf6', unlock: { level: 20 } },
  { id: 'hcolor_green',   slot: 'haircolor', name: 'Green',   color: '#22c55e', unlock: { level: 30 } },
  { id: 'hcolor_red',     slot: 'haircolor', name: 'Bold Red', color: '#dc2626', unlock: { level: 40 } },
  { id: 'hcolor_teal',    slot: 'haircolor', name: 'Teal',    color: '#14b8a6', unlock: { level: 55 } },
  { id: 'hcolor_rainbow', slot: 'haircolor', name: 'Rainbow', gradient: true,   unlock: { level: 100 } },
  ...
  { id: 'outfit_tee',        slot: 'outfit', name: 'Blue Tee',     unlock: { level: 1 } },
  { id: 'outfit_tee_crew',   slot: 'outfit', name: 'Crew Neck Tee',  unlock: { level: 1 } },
  { id: 'outfit_tee_scoop',  slot: 'outfit', name: 'Scoop Neck Tee', unlock: { level: 1 } },
  ...
  { id: 'hat_crown',   slot: 'hat', name: 'Crown',       unlock: { champion: true } },

  // --- gear (eyewear & head gear) ---
  { id: 'acc_none',       slot: 'accessory', name: 'None',       unlock: { level: 1 } },
  // Accessibility items are available from the start — not gated behind levels.
  { id: 'acc_glasses',    slot: 'accessory', name: 'Glasses',    unlock: { level: 1 } },
  { id: 'acc_hearing_aid', slot: 'accessory', name: 'Hearing Aids', unlock: { level: 1 } },
  ...
  { id: 'pet_cat',      slot: 'pet', name: 'Cat',         unlock: { level: 4 } },
  { id: 'pet_dog',      slot: 'pet', name: 'Puppy',       unlock: { level: 8 } },
  { id: 'pet_bunny',    slot: 'pet', name: 'Bunny',       unlock: { level: 12 } },
  { id: 'pet_robocat',  slot: 'pet', name: 'Robo-Cat',    unlock: { level: 16 } },
  { id: 'pet_bot',      slot: 'pet', name: 'Mini-Bot',    unlock: { level: 20 } },
  { id: 'pet_guineapig', slot: 'pet', name: 'Guinea Pig', unlock: { level: 24 } },
  // The one sidekick you cannot level your way into: it takes finding every
  // hidden capybara in the app, which awards the capybara_collector badge.
  // Was unlock: { level: 28 }.
  { id: 'pet_capybara', slot: 'pet', name: 'Capybara',    unlock: { badge: 'capybara_collector' } },
  { id: 'pet_owl',      slot: 'pet', name: 'Wise Owl',    unlock: { level: 32 } },
  { id: 'pet_gecko',    slot: 'pet', name: 'Gecko',       unlock: { level: 36 } },
  { id: 'pet_cow',      slot: 'pet', name: 'Mini Cow',    unlock: { level: 42 } },
  { id: 'pet_penguin',  slot: 'pet', name: 'Penguin Pal', unlock: { level: 48 } },
  { id: 'pet_frog',     slot: 'pet', name: 'Frog',        unlock: { level: 54 } },
  { id: 'pet_horse',    slot: 'pet', name: 'Pony',        unlock: { level: 60 } },
  { id: 'pet_dragon',   slot: 'pet', name: 'Pocket Dragon', unlock: { level: 70 } },
  { id: 'pet_phoenix',  slot: 'pet', name: 'Phoenix',     unlock: { level: 80 } },
  { id: 'pet_unicorn',  slot: 'pet', name: 'Unicorn',     unlock: { level: 90 } },
...
// `badgeIds` may be a Set or an array. `isChampion` = currently top XP in their
// department (drives the Crown).
export function isItemUnlocked(item, { level = 1, badgeIds, isChampion = false } = {}) {
  if (!item?.unlock) return true;
  if (item.unlock.champion) return !!isChampion;
...
export function unlockLabel(item) {
  ...
  if (item.unlock.champion) return 'Earn the most XP';
...
export function normalizeAvatar(avatar) {
  ...
  // Gear (accessory) is stackable — normalize to an array of ids, tolerating the
  // legacy single-string form. Empty array = nothing equipped.
  const raw = merged.accessory;
  let acc = Array.isArray(raw) ? raw.slice() : (raw && raw !== 'acc_none' ? [raw] : []);
  // Migrate any legacy hat-in-accessory to the hat slot.
  const movedHat = acc.map((id) => ACCESSORY_TO_HAT[id]).find(Boolean);
  if (movedHat && (!avatar?.hat || avatar.hat === 'hat_none')) merged.hat = movedHat;
  merged.accessory = acc.filter((id) => id !== 'acc_none' && !ACCESSORY_TO_HAT[id]);
  return merged;
}

// The equipped gear ids as an array, tolerating string / array / none.
export function accessoryList(accessory) {
  if (Array.isArray(accessory)) return accessory.filter((id) => id && id !== 'acc_none');
  return accessory && accessory !== 'acc_none' ? [accessory] : [];
}
...
// Every level-gated item that becomes available on crossing INTO levels
// (fromLevel, toLevel] — i.e. exactly what a level-up just handed the learner.
// Takes a range because one award can span more than one level (a 200 XP quest
// off a fresh account jumps two), and those unlocks must not be silently lost.
export function itemsUnlockedBetween(fromLevel, toLevel) {
  const from = Math.max(0, Math.floor(fromLevel || 0));
  const to = Math.floor(toLevel || 0);
  if (to <= from) return [];
  return AVATAR_ITEMS.filter(
    (it) => it.unlock?.level != null && it.unlock.level > from && it.unlock.level <= to
  );
}

// The nearest level ABOVE `level` that unlocks anything, with its items. Powers
// the level-up modal's "what's next" line, so a level that happens to unlock
// nothing of its own still leaves the learner something to aim at. Null once
// there's nothing left above them.
export function nextUnlockAfter(level) {
  const lvl = Math.floor(level || 1);
  let next = null;
  for (const item of AVATAR_ITEMS) {
    const at = item.unlock?.level;
    if (at != null && at > lvl && (next === null || at < next)) next = at;
  }
  if (next === null) return null;
  return { level: next, items: AVATAR_ITEMS.filter((it) => it.unlock?.level === next) };
}
