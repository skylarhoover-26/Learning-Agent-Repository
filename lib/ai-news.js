...
// groupByCategory used to live here: /ai-news was organised by what KIND of news
// each item was. The page now leads with impact on the reader (see
// lib/news-personal.js) and category is a filter, so nothing grouped by it any
// more. CATEGORY_LABELS above is still the source of the filter's option labels.
