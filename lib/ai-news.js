...
//
// Deliberately excluded: security_incident. Practical caution (safety_practice)
// is welcome; "this system can be broken" headlines are not — the goal is
// confident, careful users, not frightened ones.
