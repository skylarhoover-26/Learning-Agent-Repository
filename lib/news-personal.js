...
// How many of the newest items get judged per learner per day. The findings blob
// holds up to 200 (api/curriculum/daily), and scoring all of them would be a
// large call for items nobody scrolls to. Everything past this stays unranked
// and is shown under its own heading rather than silently dropped — a cap you
// can see is honest; a cap you can't reads as "we judged everything".
//
// KEEP IN SYNC with SCORE_LIMIT in app/api/ai-news/why/route.js.
export const RANKED_LIMIT = 40;
