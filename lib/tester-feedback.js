...
import bridgetAppFeedback from '@/data/tester-feedback/bridget-app-feedback.json';
...
const TESTER_FILES = [andreaMcFadden, emilyDolan, stormPilloff, azeretArriaga, kariaSanchez, teamTasks, bridgetAppFeedback];
