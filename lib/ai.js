...
function buildCalibrationScenariosPrompt(learnerProfile) {
  ...
  return [
    ...
    '- setup (string): 2-4 sentences describing a SPECIFIC, realistic moment from THIS PERSON\'S actual work — use their real tasks/role; name the kind of thing they\'d actually be doing',
    '- prompt (string): the question (e.g. "How would you approach this?")',
    ...
    '- The 4 options are different ways THEY might handle it with AI — from a naive approach to how an expert in their role would do it.',
