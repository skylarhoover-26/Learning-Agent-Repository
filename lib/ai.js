...
const PLAN_SHAPE = {
  standard: { objectives: '1-2', label: 'Quick Lesson (3-5 min)', steps: '3-6' },
...
const PLAN_MAX_STEPS = { standard: 6, deep_dive: 10, project_quest: 12 };

const PLAN_TOKENS = { standard: 3500, deep_dive: 7000, project_quest: 8000 };
...
export async function generateTeachStep(topic, learnerProfile, options = {}) {
  ...
  const format = options.format === 'deep_dive' || options.format === 'project_quest' ? options.format : 'standard';
