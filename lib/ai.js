...
export async function generateLessonPlan(topic, learnerProfile, options = {}) {
  ...
  const system = [
    ...
    '- Use the web_search tool to check how this actually works today. Prefer the OFFICIAL docs for the tool involved (its own documentation or changelog) over blog posts and tutorials.',
