...
const PLAN_TOKENS = { standard: 2200, deep_dive: 3500, project_quest: 3800 };
...
export async function generateLessonPlan(topic, learnerProfile, options = {}) {
  ...
  const system = [
    ...
    '- Vary the activity types across the lesson. Available types:',
    '  • "mcq": a multiple-choice check. { question, options:[4 strings], correctIndex:0-3, explanation }',
