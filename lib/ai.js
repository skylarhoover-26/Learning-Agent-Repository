...
// Output-token ceiling per format. This is the single biggest driver of how long
// a learner stares at the loader: the plan is one non-streaming call, so the
// wall clock is however long it takes to emit this much JSON. Heavier formats
// were set to 7000/8000 here, which alone runs 2-4 minutes on Sonnet and put
// Deep Dive and Project Quest past their promised times (and tripped the
// client's abort). Kept in step with PLAN_MAX_STEPS above — fewer steps means
// less JSON, so trim both together or the model truncates mid-object.
const PLAN_TOKENS = { quick_tip: 2500, standard: 3500, deep_dive: 5000, project_quest: 5000 };
