...
import { buildDailyMessage } from './daily-message';
...
// Copy now lives in lib/daily-message.js (a seeded variant pool, so the message
// differs per day and per person instead of being the same eight lines forever).
//
