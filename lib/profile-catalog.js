...
export const PROFILE_CATALOG = [
  ...
  { href: '/my-goals', label: 'My Goals', desc: 'What you want to get out of AI' },
  ...
  // My Role is deliberately absent: it merged into My Profile (2026-08-14), which
  // now carries the role manager card. /my-role redirects there.
