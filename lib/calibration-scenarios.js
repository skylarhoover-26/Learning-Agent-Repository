export const SCENARIOS = [
  ...
  },
  {
    id: 'eval',
    primary: 'eval',
    setup: "A customer says 'I called last month and was told the refund window is 60 days, not 30.' You ask Claude to verify. Claude returns a confident yes — 60 days — citing what looks like an official source link.",
  ...
  },
  {
    id: 'data',
    primary: 'data',
    setup: "You're prepping a churn analysis for tomorrow's QBR. You ask Claude: 'In this 5,000-row CSV, what's the average tenure of churned vs. retained customers?' Claude returns: '14.2 months churned vs. 31.6 months retained' — directionally what you'd expect.",
