...
export const FEATURE_HINTS = {
  ...
  // The KEY stays "Discovery" — it's stored on every existing feedback row in
  // Supabase, so renaming it would orphan them. The hint carries the current
  // on-screen name so the classifier still maps a report that says "Your AI
  // Opportunities" onto this area.
  Discovery: '/discover — shown to learners as "Your AI Opportunities"; find AI use cases for your role/work.',
