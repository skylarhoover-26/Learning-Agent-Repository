...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="page-discover"]', popover: { title: 'Now let AI find opportunities', description: "Normally you'd hit “Find AI for me.” Watch — I'll run it for you and pull up specific AI opportunities tailored to YOUR work, not generic ideas…" }, ensure: { selector: '[data-tour="discover-input"]', text: "I'm an Operations Manager. My day is status meetings, reviewing project updates, planning next quarter, and writing reports." }, autoClick: '[data-tour="discover-send"]', waitFor: '[data-tour="discover-results"]', advanceOnReady: true },
