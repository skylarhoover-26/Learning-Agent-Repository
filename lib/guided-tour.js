...
export const GUIDED_TOUR_STEPS = [
  ...
  // Today's Pick isn't a home button, so it gets its own quick walkthrough.
  { element: '[data-tour="nav-daily"]', popover: { title: "Today's Pick", description: "One personalized lesson chosen for you each day. Let's open it." } },
  { route: '/daily', element: '[data-tour="page-daily"]', popover: { title: "Today's Pick", description: 'Picked from your skill gaps and what you\'ve practiced recently — the one thing worth doing today.' } },
