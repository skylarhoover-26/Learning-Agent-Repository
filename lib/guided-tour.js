...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/', element: '[data-tour="home-skills"]', popover: { title: 'Your Skills', description: "A snapshot of your strong skills, the ones growing, and gaps to work on. Open the Knowledge Heatmap any time for the full picture." } },
  ...
  { element: '[data-tour="sidebar"]', popover: { title: 'Everything lives here', description: "Your full menu is grouped into sections. A few — like Discover, Games, Chat, Library, and Lessons — you just saw from the home screen. Here's what else lives in the menu." } },
