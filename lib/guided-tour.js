...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/', element: '[data-tour="home-xp"]', popover: { title: 'Your level & XP', description: "Track your level, XP progress, and the badges you've earned. Tap it to see all your achievements." } },
  ...
  { route: '/discover', element: '[data-tour="discover-send"]', popover: { title: 'Find AI for me', description: 'Now hit this — it surfaces specific AI opportunities for YOUR tasks, not generic ideas. Watch it run…' }, ensure: { selector: '[data-tour="discover-input"]', text: "I'm an Operations Manager. My day is status meetings, reviewing project updates, planning next quarter, and writing reports." }, autoClick: '[data-tour="discover-send"]', waitFor: '[data-tour="discover-results"]', advanceOnReady: true },
  { route: '/discover', element: '[data-tour="discover-results"]', popover: { title: 'Your results', description: 'Here they are — specific, hands-on AI opportunities tied to YOUR work. Tap any one to open a lesson built around it. Then we head back home.' } },
  ...
  { route: '/chat', element: '[data-tour="chat-send"]', popover: { title: 'Send it', description: "Hit send — or just press Enter. Watch the reply come in." }, ensure: { selector: '[data-tour="chat-input"]', text: "What's a good way to use AI to summarize long email threads?" }, autoClick: '[data-tour="chat-send"]', waitFor: '[data-tour="chat-reply"]', advanceOnReady: true },
  ...
  { route: '/', element: '[data-tour="home-qa-library"]', popover: { title: 'Library', description: "Quick link to your saved AI resources. Let's take a look." } },
  { route: '/library', element: '[data-tour="library-search"]', popover: { title: 'Search your resources', description: "Filter your saved prompts, guides, and references as you type. Watch — I'll search “email” and the list narrows instantly. Then back home." }, type: { selector: '[data-tour="library-search"]', text: 'email' } },

  { route: '/', element: '[data-tour="home-qa-quests"]', popover: { title: 'Project Quests', description: "Quick link to hands-on projects. Let's open it." } },
  { route: '/quests', element: '[data-tour="page-quests"]', popover: { title: 'Project Quests — how to use it', description: 'Browse these hands-on quests, pick one, and work through the steps to build something real — earning XP along the way. Then we head back home.' } },

  { route: '/', element: '[data-tour="home-qa-lesson"]', popover: { title: 'Quick Lesson', description: "Quick link to start a guided lesson. Let's open it and walk through it." } },
  { route: '/lesson', element: '[data-tour="page-lesson"]', popover: { title: 'Step 1 — how deep?', description: 'Start by choosing the depth: a 60-second Quick Tip, a hands-on Quick Lesson, or a thorough Deep Dive.' } },
  ...
  { route: '/lesson', element: '[data-tour="lesson-topics"]', popover: { title: 'Step 3 — pick a topic', description: 'Tap a suggested topic, or type your own just below.' } },
  ...
  { route: '/lesson', element: '[data-tour="lesson-start"]', popover: { title: 'Start the lesson', description: 'Hit Start and your lesson builds around that topic instantly. Watch it kick off, then we head back home.' }, ensure: { selector: '[data-tour="lesson-custom-input"]', text: 'How to use AI to draft status update emails' }, autoClick: '[data-tour="lesson-start"]', waitFor: '[data-tour="lesson-content"]', advanceOnReady: true },
  { route: '/lesson', element: '[data-tour="lesson-content"]', popover: { title: 'Your lesson is ready', description: 'Here it is — work through it step by step, answering and asking questions as you go. Then we head back home.' } },

  // Remaining home cards — highlights only (not full sections to dive into).
  { route: '/', element: '[data-tour="home-todays-pick"]', popover: { title: "Today's Pick", description: 'A lesson hand-picked for you each day based on your progress — tap to start it.' } },
  ...
  { route: '/', element: '[data-tour="home-leaderboard"]', popover: { title: 'Department Leaderboard', description: 'See how your team is doing, and tap through to the full leaderboard.' } },
  { route: '/', element: '[data-tour="home-skills"]', popover: { title: 'Your Skills', description: 'A snapshot of your strong skills, the ones growing, and gaps to work on — with a link to your full skill graph.' } },
  ...
  // Daily isn't a home button, so it gets its own quick walkthrough.
  ...
  { element: '[data-tour="section-learn"]', popover: { title: 'More ways to learn', description: 'Learn also has Modules, Practice, Prompts, and Quick Win.' } },
