...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="discover-send"]', popover: { title: 'Find AI for me', description: 'Now hit this — it surfaces specific AI opportunities for YOUR tasks, not generic ideas. Watch it run…' }, autoClick: '[data-tour="discover-send"]' },
  ...
  { route: '/chat', element: '[data-tour="chat-send"]', popover: { title: 'Send it', description: "Hit send — or just press Enter. Watch the reply come in." }, autoClick: '[data-tour="chat-send"]' },
  ...
  { route: '/lesson', element: '[data-tour="lesson-start"]', popover: { title: 'Start the lesson', description: 'Hit Start and your lesson builds around that topic instantly. Watch it kick off, then we head back home.' }, autoClick: '[data-tour="lesson-start"]' },
