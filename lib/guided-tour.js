...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/', element: '[data-tour="home-find-ai"]', popover: { title: 'Here’s where you find AI for your work', description: 'Describe what you do and AI turns it into specific ways to use it — each one opens a lesson built around your job.' } },
  ...
  { route: '/', element: '[data-tour="home-todays-pick"]', popover: { title: 'Today’s Pick sits right here', description: 'One fresh lesson chosen for you each day, based on your gaps and recent activity.' } },
  ...
  { route: '/', element: '[data-tour="home-leaderboard"]', popover: { title: 'The team leaderboard is here', description: 'See how you and your teammates stack up as everyone earns XP.' } },
  ...
  { route: '/', element: '[data-tour="home-news"]', popover: { title: 'AI news lives here', description: 'The latest AI updates, refreshed daily — tap any card to turn it into a lesson.' } },
