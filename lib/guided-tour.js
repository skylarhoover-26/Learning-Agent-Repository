...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/chat', element: '[data-tour="chat-send"]', popover: { title: 'Send it', description: "Hit send — or just press Enter. Watch the reply come in." }, ensure: { selector: '[data-tour="chat-input"]', text: "What's a good way to use AI to summarize long email threads?" }, autoClick: '[data-tour="chat-send"]', waitFor: '[data-tour="chat-reply"]' },
