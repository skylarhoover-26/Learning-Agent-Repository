...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="page-discover"]', popover: { title: 'Discover — how to use it', description: 'Describe your day-to-day work in this box and hit “Find AI for me.” It surfaces specific AI opportunities for YOUR tasks — not generic ideas. Then we head back home.' } },
  ...
  { route: '/chat', element: '[data-tour="chat-input"]', popover: { title: 'Type your question', description: "Or click into this box and type any AI question, in plain language — no special wording needed." } },
  { route: '/chat', element: '[data-tour="chat-send"]', popover: { title: 'Send it', description: "Hit send — or just press Enter — to fire off your question." } },
  ...
  { route: '/library', element: '[data-tour="page-library"]', popover: { title: 'Library — how to use it', description: 'Search and filter your saved prompts, guides, and references here — everything in one place to revisit anytime. Then back home.' } },
  ...
  { route: '/lesson', element: '[data-tour="lesson-topics"]', popover: { title: 'Step 3 — pick a topic', description: 'Tap a suggested topic, or type your own just below — your lesson builds around it instantly. Then back home.' } },
