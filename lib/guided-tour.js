...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="discover-send"]', popover: { title: 'Find AI for me', description: 'Now hit this — it surfaces specific AI opportunities for YOUR tasks, not generic ideas. Watch it run, then we head back home.' }, autoClick: '[data-tour="discover-send"]' },
