...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="discover-main"]', popover: { title: 'Now let AI find opportunities', description: "Normally you'd hit “Find AI for me.” Watch — I'll run it for you and pull up specific AI opportunities tailored to YOUR work, not generic ideas…" }, ensure: { selector: '[data-tour="discover-input"]', text: "I'm an Operations Manager. My day is status meetings, reviewing project updates, planning next quarter, and writing reports." }, autoClick: '[data-tour="discover-send"]', waitFor: '[data-tour="discover-results"]', advanceOnReady: true },
  ...
  { route: '/lesson', element: '[data-tour="lesson-start"]', popover: { title: 'Start the lesson', description: "This is Start — the button you'd hit. Watch, I'll start it for you and your lesson builds around that topic instantly." }, ensure: { selector: '[data-tour="lesson-custom-input"]', text: 'How to use AI to draft status update emails' }, autoClick: '[data-tour="lesson-start"]', waitFor: '[data-tour="lesson-content"]', advanceOnReady: true },
