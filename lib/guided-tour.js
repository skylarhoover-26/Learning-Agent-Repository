...
export const GUIDED_TOUR_STEPS = [
  ...
  { route: '/discover', element: '[data-tour="discover-send"]', popover: { title: 'Find AI for me', description: "This is the button you'd hit. Watch — I'll run it for you. It surfaces specific AI opportunities for YOUR tasks, not generic ideas…" }, ensure: { selector: '[data-tour="discover-input"]', text: "I'm an Operations Manager. My day is status meetings, reviewing project updates, planning next quarter, and writing reports." }, autoClick: '[data-tour="discover-send"]', waitFor: '[data-tour="discover-results"]', advanceOnReady: true },
