...
import { formatFindings, QUARANTINE_NOTE } from './untrusted';
...
async function classifyBatch(batch) {
  ...
  //
  // The blurb is also feed-supplied, and 160 chars is ample room for an
  // instruction, so both it and the title are quarantined (security review F-10).
  const list = formatFindings(batch, { showUrl: false, showSummary: true });
