...
//
// Every finding gets a category; nothing is discarded. The display layer decides
// what to show (see APPROVED_CATEGORIES in lib/ai-news.js), so the rubric can be
// retuned without re-scanning.
...
export const CATEGORIES = [
  ...
  // ---- stored but hidden ----
  'security_incident',// attacks, breaches, exploits, vulnerabilities
