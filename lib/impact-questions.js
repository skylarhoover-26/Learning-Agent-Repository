...
export const IMPACT_QUESTIONS = [
  {
    ...
    options: [
      ...
      { value: 'D', label: 'AI has genuinely changed what I can produce — my work is noticeably better or faster', self: 5 },
    ],
  },
  {
    dimension: 'team',
    ...
    options: [
      ...
      { value: 'D', label: "I actively coach my team on AI — it's something I intentionally bring into our work", self: 5 },
    ],
  },
  {
    dimension: 'org',
    ...
    options: [
      ...
      { value: 'D', label: "Definitely — I've built or shared AI practices that others now use, and I can show the impact", self: 5 },
    ],
  },
  {
    ...
    options: [
      { value: 'A', label: "I know the basics, but I'm still learning what's out there", self: 2 },
      { value: 'B', label: "I use a handful of tools comfortably — I'm consistent but not experimenting much", self: 3 },
      { value: 'C', label: 'I actively try new things and can adapt AI tools to different situations', self: 4 },
      { value: 'D', label: 'I go deep — I understand how models work, I experiment with new techniques, and others come to me for guidance', self: 5 },
    ],
  },
];
