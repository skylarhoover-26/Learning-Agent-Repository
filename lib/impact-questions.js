...
// a multiple-choice self-claim plus a written example. BOTH halves are scored —
// ImpactIntroStep tells people so before they start. The MC pick gives
...
export const IMPACT_QUESTIONS = [
  {
    ...
    example: 'Give one or two examples of how AI has changed what you produce or deliver.',
    options: [
  ...
  },
  {
    ...
    example: 'Give one or two recent examples of you helping someone on your team use AI more effectively.',
    options: [
  ...
  },
  {
    ...
    example: 'Give one or two examples of AI helping you connect to team goals or broader business outcomes.',
    options: [
  ...
  },
  {
    ...
    example: 'Give one or two examples of you learning, experimenting with, or adapting AI tools and techniques.',
    options: [
