...
export const MENU_CATALOG = [
  {
    title: 'Learn',
    // Importance order, not alphabetical — KEEP IN SYNC with the Learn group in
    // components/sidebar.jsx (that file carries the reasoning).
    items: [
      { href: '/discover', label: 'Your AI Opportunities', desc: 'Find AI for your work' },
      ...
      { href: '/ai-news', label: 'AI News', desc: 'The latest AI updates — take a lesson on any of them' },
    ],
  },
  {
