...
export const MENU_CATALOG = [
  {
    title: 'Learn',
    items: [
      { href: '/discover', label: 'Library/Discovery', desc: 'Find AI for your work + browse the use case library' },
      ...
      { href: '/structured-lesson', label: 'Practice', desc: 'Hands-on exercises with instant feedback' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/scoring', label: 'AI Impact', desc: 'Measure how AI is helping your work' },
      { href: '/calibration', label: 'Calibrate', desc: 'Tune lessons to your current level' },
      { href: '/checkin', label: 'Check-in', desc: 'A quick pulse on your progress' },
      { href: '/goals', label: 'Goals', desc: 'Set and track your learning goals' },
      ...
      { href: '/quests', label: 'Quests', desc: 'Build something real, start to finish' },
      { href: '/review', label: 'Review', desc: 'Revisit key concepts so they stick' },
      { href: '/skill-graph', label: 'Skill Graph', desc: 'A visual map of your AI skills' },
    ],
  },
  {
    title: 'Manager',
