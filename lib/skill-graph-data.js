const GRAPH_NODES = [
  { id: 'ai-fundamentals', name: 'AI Fundamentals', category: 'Foundations', mastery: 82, freshness: 3 },
  { id: 'prompt-basics', name: 'Prompt Basics', category: 'Foundations', mastery: 75, freshness: 8 },
  { id: 'customer-comms', name: 'Customer Comms', category: 'Foundations', mastery: 68, freshness: 45 },
  { id: 'system-prompts', name: 'System Prompts', category: 'Foundations', mastery: 30, freshness: 90 },
  { id: 'data-privacy', name: 'Data Privacy & PII', category: 'Application', mastery: 55, freshness: 12 },
  { id: 'safety-redteam', name: 'Safety & Red-teaming', category: 'Application', mastery: 20, freshness: 120 },
  { id: 'email-drafting', name: 'Email Drafting', category: 'Application', mastery: 88, freshness: 2 },
  { id: 'report-writing', name: 'Report Writing', category: 'Application', mastery: 45, freshness: 30 },
  { id: 'eval-hallucinations', name: 'Eval & Hallucinations', category: 'Safety', mastery: 60, freshness: 5 },
  { id: 'bias-fairness', name: 'Bias & Fairness', category: 'Safety', mastery: 15, freshness: 180 },
  { id: 'ai-ethics', name: 'AI Ethics', category: 'Safety', mastery: 35, freshness: 60 },
  { id: 'compliance', name: 'Compliance', category: 'Safety', mastery: 50, freshness: 25 },
  { id: 'ai-agents', name: 'AI Agents & Tools', category: 'Frontier', mastery: 10, freshness: 200 },
  { id: 'image-voice', name: 'Image & Voice', category: 'Frontier', mastery: 25, freshness: 90 },
  { id: 'reasoning', name: 'Reasoning Models', category: 'Frontier', mastery: 5, freshness: 300 },
  { id: 'multimodal', name: 'Multimodal AI', category: 'Frontier', mastery: 8, freshness: 250 },
];
