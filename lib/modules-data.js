    ...
    sections: [
      {
        ...
        content: 'AI tools like Gemini are language models — they predict what text should come next based on patterns in their training data. They\'re excellent at drafting, summarizing, rewriting, and structuring text. They\'re unreliable for real-time info, precise math, and decisions that require context they don\'t have.',
      },
      {
    ...
    sections: [
      {
        ...
        content: 'Copy-pasting between Gemini and your work tools is a workflow, but it\'s manual. The next level: connecting AI directly to the systems you use — Slack, email, spreadsheets, CRM. Tools like n8n, Zapier, and Make let you trigger AI steps automatically when events happen.',
      },
      {
