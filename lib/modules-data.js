export const MODULES = [
    ...
    sections: [
      {
        ...
        content: 'An AI tool like ChatGPT, Gemini, or Claude is a large language model (LLM) — it predicts what text should come next based on patterns in its training data. These models are excellent at drafting, summarizing, rewriting, and structuring text. They\'re unreliable for real-time info, precise math, and decisions that require context they don\'t have.',
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'Try it now',
        content: 'On the Lesson screen, tap Surprise me. You\'ll get a ready-to-use prompt for your role that you can try in your AI tool right now. Your first win takes under 5 minutes.',
    ...
    activity: {
      ...
      description: 'Tap Surprise me on the Lesson screen, complete one quick win, and notice how long it takes compared to doing it manually.',
      action: { label: 'Surprise me', href: '/lesson?surprise=1' },
    },
  },
  {
    ...
    sections: [
      {
        ...
        content: 'Copy-pasting between the AI Chat and your work tools is a workflow, but it\'s manual. The next level: connecting AI directly to the systems you use — Slack, email, spreadsheets, CRM. Tools like n8n, Zapier, and Make let you trigger AI steps automatically when events happen.',
      },
      {
