export const MODULES = [
    ...
    sections: [
      {
        ...
        content: 'The AI Chat built into this app (powered by Claude) is a large language model — it predicts what text should come next based on patterns in its training data. These models are excellent at drafting, summarizing, rewriting, and structuring text. They\'re unreliable for real-time info, precise math, and decisions that require context they don\'t have.',
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'Try it now',
        content: 'Go to the Quick Win page and pick your top task. You\'ll get a ready-to-use prompt you can try in AI Chat right now. Your first win takes under 5 minutes.',
