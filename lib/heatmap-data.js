const SKILL_DEFS = [
  { category: 'Foundations', name: 'AI Fundamentals', keywords: ['ai fundamentals', 'what ai', 'how ai works', 'language model', 'machine learning', 'llm'] },
  { category: 'Foundations', name: 'Prompt Basics', keywords: ['prompt', 'rctf', 'prompting', 'how to prompt', 'write a prompt'] },
  { category: 'Foundations', name: 'Customer Comms', keywords: ['customer', 'communication', 'comms', 'support', 'customer service', 'response'] },
  { category: 'Foundations', name: 'System Prompts', keywords: ['system prompt', 'instruction', 'persona', 'role prompt'] },
  { category: 'Application', name: 'Data Privacy', keywords: ['privacy', 'pii', 'data privacy', 'sensitive data', 'anonymize', 'gdpr'] },
  { category: 'Application', name: 'Email Drafting', keywords: ['email', 'draft', 'writing email', 'outreach', 'follow-up'] },
  { category: 'Application', name: 'Report Writing', keywords: ['report', 'summary', 'summarize', 'document', 'writing report', 'qbr'] },
  { category: 'Application', name: 'RAG & Grounding', keywords: ['rag', 'grounding', 'retrieval', 'knowledge base', 'context window', 'embedding'] },
  { category: 'Safety', name: 'Eval & Hallucinations', keywords: ['hallucination', 'eval', 'evaluation', 'verify', 'accuracy', 'fact check'] },
  { category: 'Safety', name: 'Bias & Fairness', keywords: ['bias', 'fairness', 'discrimination', 'inclusive', 'equitable'] },
  { category: 'Safety', name: 'AI Ethics', keywords: ['ethics', 'ethical', 'responsible ai', 'transparency', 'accountability'] },
  { category: 'Safety', name: 'Compliance', keywords: ['compliance', 'regulation', 'legal', 'policy', 'audit', 'governance'] },
  { category: 'Frontier', name: 'AI Agents', keywords: ['agent', 'agents', 'tool use', 'autonomous', 'agentic', 'workflow automation'] },
  { category: 'Frontier', name: 'Image & Voice', keywords: ['image', 'voice', 'vision', 'audio', 'text to speech', 'tts', 'image generation'] },
  { category: 'Frontier', name: 'Reasoning Models', keywords: ['reasoning', 'chain of thought', 'thinking', 'o1', 'o3', 'deep thinking'] },
  { category: 'Frontier', name: 'Multimodal', keywords: ['multimodal', 'multi-modal', 'video', 'pdf', 'document understanding'] },
];
