...
const GAME_TYPES = [
  ...
  { id: 'twotruths', title: 'Two Truths & a Lie', tint: '#1AA06A', diff: 'Easy', diffTint: '#1AA06A', live: true, slug: 'two-truths',
    desc: 'Spot the false claim among three about your topic.', icon: ScanSearch },
  { id: 'wheel', title: 'Wheel of Fortune', tint: '#6AABFF', diff: 'Medium', diffTint: '#C98A00', live: true, slug: 'wheel-of-fortune',
