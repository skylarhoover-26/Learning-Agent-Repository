  ...
  return (
    <div className="min-h-screen bg-bg-subtle">
      <PageHeader
        ...
        subtitle="Curriculum change proposals"
      />
      ...
      <main className="max-w-6xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-card p-4">
            <p className="text-xs font-semibold text-ink-light uppercase tracking-wide">
              Pending
            </p>
        ...
        {/* Filter Tabs */}
        <div className="flex gap-1 bg-white rounded-lg shadow-card p-1">
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  isActive
                    ? 'bg-brand text-white'
                    : 'text-ink-light hover:bg-bg-subtle'
                }`}
              >
                {tab.label} ({count})
              </button>
