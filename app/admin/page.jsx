...
const ADMIN_TOOLS = [
  ...
  { href: '/admin/onboarding-quiz', icon: ClipboardList, title: 'Onboarding Quiz', desc: 'Write the placement questions every new user answers — answers, scoring, the best answer and why' },
