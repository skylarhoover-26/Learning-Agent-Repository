  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 pb-16">
      ...
      <div className="text-center mb-6">
        <div className="text-[11px] font-bold uppercase tracking-[.18em] mb-1" style={{ color: 'var(--accent)' }}>Wheel of Fortune</div>
        <h1 className="font-display font-extrabold tracking-tight text-ink dark:text-slate-100" style={{ fontSize: 'clamp(20px,3vw,30px)' }}>{puzzle.category}</h1>
      </div>
