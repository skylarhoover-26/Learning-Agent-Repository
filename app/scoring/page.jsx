...
export default function ScoringPage() {
  ...
  async function handleFollowUpSubmit() {
    ...
    try {
      ...
      setScores(prev => ({ ...prev, [currentQuestion.dimension]: 3 }));
      setShowFollowUp(false);
      setFollowUpText('');
      advanceStep();
    } finally {
  ...
  function finishAssessment() {
    ...
    if (step === totalSteps - 1 && !finalScores[currentQuestion.dimension]) {
      return;
    }
    ...
    return (
      <div className="min-h-screen bg-bg-warm dark:bg-slate-900">
        ...
        <main className="max-w-2xl mx-auto px-6 py-10">
          <ResultsCard scores={scores} previousScores={existingScores} />
